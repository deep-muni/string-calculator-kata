...
class StringCalculatorShould {
  ...
  void return_0_for_null_or_empty_string() {
    assertThat(stringCalculator.evaluate("")).isZero();
    assertThat(stringCalculator.evaluate(null)).isZero();
  }

  @Test
  void return_same_number_for_single_digit_in_string() {
    assertThat(stringCalculator.evaluate("1")).isEqualTo(1);
  }

  @Test
  void return_sum_for_input_with_two_integers() {
    assertThat(stringCalculator.evaluate("1,2")).isEqualTo(3);
  }

  @Test
  void return_sum_for_input_with_more_than_two_integers() {
    assertThat(stringCalculator.evaluate("1,2,3,4")).isEqualTo(10);
  }

  @Test
  void return_sum_for_input_string_with_new_line_as_delimiter() {
    assertThat(stringCalculator.evaluate("1\n2,3\n4")).isEqualTo(10);
  }

  @Test
  void return_sum_for_input_string_with_single_custom_delimiter() {
    assertThat(stringCalculator.evaluate("//;\n1;2,3\n4")).isEqualTo(10);
  }
  ...
  void throw_exception_when_negative_number_is_present_in_string() {
    Exception exception =
        assertThrows(
            NegativeNumberNotAllowedException.class, () -> stringCalculator.evaluate("-1,-2,3,4"));
